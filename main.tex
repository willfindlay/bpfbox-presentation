...
Special thanks to:
\begin{itemize}
    \item \textbf{Alexei Starovoitov} and \textbf{Daniel Borkman} (creators of eBPF)
...
\begin{itemize}
    \item First full policy \textbf{enforcement engine} written in eBPF
...
\end{itemize}
\begin{center}
    \includegraphics[width=0.33\textwidth]{figs/bpfbox-qrcode.png}\\
